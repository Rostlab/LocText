...
def _select_annotator_model(args):
    ...
    ann_switcher = {
        ...
        "SS": LocTextSSmodelRelationExtractor(pro_id, loc_id, rel_id, feature_generators=indirect_feature_generators, model=None, classification_threshold=args.svm_threshold_ss_model, use_tree_kernel=args.use_tk, kernel='linear', C=1, class_weight=None),
